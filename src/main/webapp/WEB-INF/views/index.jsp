		...
		<div class="wrapper">
			...
			<div class="content">
				<div id="form_wrapper" class="form_wrapper">
					...
					<!--  Login Form Html -->
					<form:form class="login active"  commandName="login" action="getLogin.htm" method="POST">
						<h3>Login</h3>
						<div>
							<label>Username:</label>
							<form:input type="text" path="username" id="username" name="username" value ="${login.username}" />
							<span class="error">This is an error</span>
						</div>
						<div>
							<label>Password: <a href="forgot_password.html" rel="forgot_password" class="forgot linkform">Forgot your password?</a></label>
							<form:input type="password" path="password" id="password" name="password" value ="${login.password}"/>
							<span class="error">This is an error</span>
						</div>
						<div class="bottom">
